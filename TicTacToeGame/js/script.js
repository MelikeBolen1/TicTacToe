...
const wins= [[0, 1, 2], [3, 4, 5], [6, 7, 8], [0, 4, 8], [6, 4, 2], [2, 5, 8], [1, 4, 7], [0, 3, 6]];
...
const checkWin = (board, player) => {
    ...
    for (let [index, winComboSpaces] of wins.entries()) {
...
const gameOver = gameWon => {
    for (let index of wins[gameWon.index]) {
        ...
        document.getElementById(index).style.backgroundColor = '#38e8e8';
    }
